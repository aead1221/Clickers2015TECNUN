...
public class UpdateTestChanges extends HttpServlet {
	...
	public void doGet (HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String sqlUpdate = "UPDATE Questions SET QuestionT='" + Preguntas[i] + "' WHERE IdTest=" + idexam + " AND IdQuestion=" + j + "";
		...
		String sqlUpdate = "UPDATE Questions SET Answer=" + Answer[q] + " WHERE IdTest=" + idexam + " AND IdQuestion=" + a + "";
		System.out.println(sqlUpdate);
		...
		for (int d=0; d<num; d++) {
			for (int p=0; p<op; p++) {
				int f = d + 1;
				int g = p + 1;
				String sqlUpdate = "UPDATE Options SET OptionT='" + Options[suma] + "' WHERE IdTest=" + idexam + " AND IdQuestion=" + f + "AND IdOption=" + g + "";
				suma = suma + 1;
				System.out.println(sqlUpdate);
