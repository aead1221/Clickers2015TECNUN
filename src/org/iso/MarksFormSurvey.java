...
public class MarksFormSurvey extends HttpServlet {
	...
	public void doGet (HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		clickers.printTop(resp, session.getAttribute("name").toString(), session.getAttribute("user").toString());
			...
			String sql="SELECT  FirstName, LastName1, LastName2, Id_Student from Users,SurveyStudent where SurveyStudent.Id_Student=Users.IdUser and SurveyStudent.Id_Survey="+SurveyId+"";
