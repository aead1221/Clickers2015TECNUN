...
//		out.println("<div id=\"clk-user-buttons\">");
		...
		int testcount = 0;
		String sql = "Select Id_Test FROM TestStudent WHERE Id_Student='" + idstudent + "'";
		...
		String sql1 = "Select Id_Test, Mark FROM TestStudent WHERE Id_Student='" + idstudent + "'";
		int sum = 0;
		...
		for (int i=0; i<testcount; i++) {
			...
			String sql2 = "Select Description FROM Tests WHERE Id_Tests=" + codtest[i] + "";
			...
			while(result.next()) {
			testName[i] = result.getString("Description");
			}
			}
