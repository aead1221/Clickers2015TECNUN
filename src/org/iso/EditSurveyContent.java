...
public void doGet (HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String sql = "Select Survey, NumberOfQuestions, NumberOfOptions FROM SurveyAI WHERE Id_Survey=" + id +"";
		...
		String sqlz = "Select OptionB FROM SoptionsAI WHERE IdSurvey=" + id + "";
		...
		String sqlo = "Select Id_Question, Question FROM SquestionsAI WHERE Id_Survey=" + id +"";
