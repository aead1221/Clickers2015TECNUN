...
public class TestTemplate extends HttpServlet {
	...
	public void doGet (HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<FORM Action='SaveTestData'>");
		out.println("<FORM Action='SaveTestData'>");
		out.println("<table>");
		for(int i=0; i<num; i++){
			int v = i + 1;
			out.println("<tr><td colspan='2'><h4> Question " + v +"<h4></td></tr>");
			out.println("<tr><td colspan='2'><INPUT type='text' name='question' style='width:200px;'></td><td colspan='2'><h4> Answer <h4></td><td colspan='2'><INPUT type='text' name='answer' style='width:30px;'></td></tr>");
			for(int j=0; j<op; j++) {
				int w = j + 1;
