...
public class Administrator extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
        ...
        String sql = "Select IdUser, UserType, FirstName , LastName1, LastName2  FROM Users";
        ...
        try {
            ...
            while(result.next()) {
				...
				String ustype = result.getString("UserType");					
                toClient.println("<td>"+ name + " " + lname1 + " " + lname2 + " </td>");
                toClient.println("<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + ustype + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>");
                toClient.println("<td><a href=\"EditUser.html\"><button class='clk-button' >&nbsp;&nbsp; Modify &nbsp;&nbsp;</button ></a></td>");
				toClient.println("<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>");
                toClient.println("<td><a href=\"#\"> <button class='clk-button' >&nbsp;&nbsp; Disable &nbsp;&nbsp;</button ></a></td>");
                toClient.println("</tr>");
            }
