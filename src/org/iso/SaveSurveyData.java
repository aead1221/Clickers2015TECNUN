...
public class SaveSurveyData extends HttpServlet {
	...
	String sql = "Select Id_Survey FROM SurveyAI";
	...
	String sqlf = "INSERT INTO SurveyAI (Id_Survey, Survey, Id_Subject, Id_Teacher, NumberOfQuestions, NumberOfOptions) VALUES (";	   
	sqlf +=  "'" + idsurvey + "'";
    sqlf +=  ", '" + nom + "'";
	sqlf +=  ", '" + idsubject + "'";
	sqlf +=  ", '" + idteach + "'"; //idteach
	sqlf +=  ", '" + num + "'";
    sqlf +=  ", '" + op + "')";
	...
	for (int i=0; i<Preguntas.length; i++) {
			String sqli = "INSERT INTO SquestionsAI (Id_Question, Question, Id_Survey) VALUES (";
			int j = i + 1;
			sqli +=  "" + j + "";
			sqli +=  ", '" + Preguntas[i] + "'";
			sqli +=  ", " + idsurvey + ")";
	...
	for (int k=0; k<Preguntas.length; k++) {
			int p = k + 1;
			for (int l=0; l<op; l++) {
			String sqlfu = "INSERT INTO SoptionsAI (IdOption, OptionB, IdSurvey, IdQuestion) VALUES (";
			int g = l + 1;
			optiones = "";
