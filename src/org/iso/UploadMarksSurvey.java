...
public class UploadMarksSurvey extends HttpServlet {
	...
	public void doGet (HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		clickers.printTop(resp, session.getAttribute("name").toString());
			...
			String sql2="SELECT  FirstName, LastName1, LastName2, Mark from StudentsBF,SurveyStudentBF where Id_Student= Id and Id_Survey="+SurveyId+"";
  ...
  public int actualizarBaseDeDatos() {
	...
	String sql3="SELECT distinct  Id_Student,LastName2 from SurveyStudentBF,StudentsBF where Id_Student=Id and LastName2='"+ apellido1+"'";
	...
	System.out.println("dentro bucle: " +Id);
		...
		String strSql = "UPDATE SurveyStudentBF SET " //Tabla de la base de datos a la que apunta el DSN en la que queramos hacer una actualizacion 
